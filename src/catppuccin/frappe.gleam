...
pub fn rosewater() -> CatppuccinColor {
  CatppuccinColor(
    ...
    colour_result: colour.from_rgb255(r: 242, g: 213, b: 207),
  )
}
...
pub fn flamingo() -> CatppuccinColor {
  CatppuccinColor(
    ...
    colour_result: colour.from_rgb255(r: 238, g: 190, b: 190),
  )
}
...
pub fn pink() -> CatppuccinColor {
  CatppuccinColor(
    ...
    colour_result: colour.from_rgb255(r: 244, g: 184, b: 228),
  )
}
...
pub fn mauve() -> CatppuccinColor {
  CatppuccinColor(
    ...
    colour_result: colour.from_rgb255(r: 202, g: 158, b: 230),
  )
}
...
pub fn red() -> CatppuccinColor {
  CatppuccinColor(
    ...
    colour_result: colour.from_rgb255(r: 231, g: 130, b: 132),
  )
}
...
pub fn maroon() -> CatppuccinColor {
  CatppuccinColor(
    ...
    colour_result: colour.from_rgb255(r: 234, g: 153, b: 156),
  )
}
...
pub fn peach() -> CatppuccinColor {
  CatppuccinColor(
    ...
    colour_result: colour.from_rgb255(r: 239, g: 159, b: 118),
  )
}
...
pub fn yellow() -> CatppuccinColor {
  CatppuccinColor(
    ...
    colour_result: colour.from_rgb255(r: 229, g: 200, b: 144),
  )
}
...
pub fn green() -> CatppuccinColor {
  CatppuccinColor(
    ...
    colour_result: colour.from_rgb255(r: 166, g: 209, b: 137),
  )
}
...
pub fn teal() -> CatppuccinColor {
  CatppuccinColor(
    ...
    colour_result: colour.from_rgb255(r: 129, g: 200, b: 190),
  )
}
...
pub fn sky() -> CatppuccinColor {
  CatppuccinColor(
    ...
    colour_result: colour.from_rgb255(r: 153, g: 209, b: 219),
  )
}
...
pub fn sapphire() -> CatppuccinColor {
  CatppuccinColor(
    ...
    colour_result: colour.from_rgb255(r: 133, g: 193, b: 220),
  )
}
...
pub fn blue() -> CatppuccinColor {
  CatppuccinColor(
    ...
    colour_result: colour.from_rgb255(r: 140, g: 170, b: 238),
  )
}
...
pub fn lavender() -> CatppuccinColor {
  CatppuccinColor(
    ...
    colour_result: colour.from_rgb255(r: 186, g: 187, b: 241),
  )
}
...
pub fn text() -> CatppuccinColor {
  CatppuccinColor(
    ...
    colour_result: colour.from_rgb255(r: 198, g: 208, b: 245),
  )
}
...
pub fn subtext1() -> CatppuccinColor {
  CatppuccinColor(
    ...
    colour_result: colour.from_rgb255(r: 181, g: 191, b: 226),
  )
}
...
pub fn subtext0() -> CatppuccinColor {
  CatppuccinColor(
    ...
    colour_result: colour.from_rgb255(r: 165, g: 173, b: 206),
  )
}
...
pub fn overlay2() -> CatppuccinColor {
  CatppuccinColor(
    ...
    colour_result: colour.from_rgb255(r: 148, g: 156, b: 187),
  )
}
...
pub fn overlay1() -> CatppuccinColor {
  CatppuccinColor(
    ...
    colour_result: colour.from_rgb255(r: 131, g: 139, b: 167),
  )
}
...
pub fn overlay0() -> CatppuccinColor {
  CatppuccinColor(
    ...
    colour_result: colour.from_rgb255(r: 115, g: 121, b: 148),
  )
}
...
pub fn surface2() -> CatppuccinColor {
  CatppuccinColor(
    ...
    colour_result: colour.from_rgb255(r: 98, g: 104, b: 128),
  )
}
...
pub fn surface1() -> CatppuccinColor {
  CatppuccinColor(
    ...
    colour_result: colour.from_rgb255(r: 81, g: 87, b: 109),
  )
}
...
pub fn surface0() -> CatppuccinColor {
  CatppuccinColor(
    ...
    colour_result: colour.from_rgb255(r: 65, g: 69, b: 89),
  )
}
...
pub fn base() -> CatppuccinColor {
  CatppuccinColor(
    ...
    colour_result: colour.from_rgb255(r: 48, g: 52, b: 70),
  )
}
...
pub fn mantle() -> CatppuccinColor {
  CatppuccinColor(
    ...
    colour_result: colour.from_rgb255(r: 41, g: 44, b: 60),
  )
}
...
pub fn crust() -> CatppuccinColor {
  CatppuccinColor(
    ...
    colour_result: colour.from_rgb255(r: 35, g: 38, b: 52),
  )
}